...
public class MultipleTestNGTestCases {
	// Default priority = 0 (if not mentioned).
	// If multiple test methods have the same priority, they run in alphabetical
	// order.
	// Lower priority value = Higher execution order priority = 0 runs before
	// priority = 1.
	@Test(priority=0)
